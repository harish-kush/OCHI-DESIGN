...
const Footer = () => {
  return (
    <div className='w-full h-screen bg-zinc-900 flex gap-2'>
      <div className='w-1/2 h-full flex flex-col justify-between ml-10'>
        <div className="heading">
          <h1 className="text-[8vw] font-semibold uppercase leading-none font-['sb'] ">EYE-</h1>
          <h1 className="text-[8vw] font-semibold uppercase leading-none font-['sb'] ">OPENING</h1>
        </div>
        <svg className='mb-16'
            width="72"
            height="30"
      ...
      <h1 className="text-[8vw] font-semibold uppercase leading-none font-['sb'] ">PRESENTATION</h1>
      <div className="dets font-['nm1'] flex flex-col gap-2 my-10">
        <a href=''>Facebook</a>
        <a href=''>Instagram</a>
        <a href=''>Twitter</a>
        <a href=''>Linkedin</a>
